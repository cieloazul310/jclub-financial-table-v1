...
import { Blockquote, Alert, SubParagraph } from '@cieloazul310/gatsby-theme-aoi';
...
export default { Typography, Green, Red, SimpleTable, SummaryTable, SummaryTableRow, Ad, Diff, Blockquote, Alert, SubParagraph };
